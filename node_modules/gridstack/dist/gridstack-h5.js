        ...
        var t = {
            21: (t, e, i) => {
                ...
                e.GridStackDD = n, r.GridStack.prototype._setupAcceptWidget = function () {
                    ...
                    if (!this.opts.acceptWidgets) return n.get().droppable(this.el, {accept: t => t.gridstackNode && t.gridstackNode.grid === this}), this;
                    let t = (t, e) => {
                        let i = e.gridstackNode, s = this.getCellFromPixel({left: t.pageX, top: t.pageY}, !0),
                            r = Math.max(0, s.x), o = Math.max(0, s.y);
                        if (i._added) r === i.x && o === i.y || !this.engine.canMoveNode(i, r, o) || (this.engine.moveNode(i, r, o), this._updateContainerHeight()); else {
                    ...
                    return n.get().droppable(this.el, {
                        accept: t => {
                            ...
                            let i = !0;
                            if ("function" == typeof this.opts.acceptWidgets) i = this.opts.acceptWidgets(t); else {
                                let e = !0 === this.opts.acceptWidgets ? ".grid-stack-item" : this.opts.acceptWidgets;
                                i = t.matches(e)
                            }
                            if (i && e && this.opts.maxRow) {
                                let t = {w: e.w, h: e.h, minW: e.minW, minH: e.minH};
                        ...
                        let s = e.gridstackNode, r = !!this.placeholder.parentElement;
                    ...
                    let r = (r, o) => {
                        ...
                        let l, a, h, d = Math.round(n.position.left / e), g = Math.round(n.position.top / i);
                        if ("drag" === r.type) {
                    ...
                    return n.get().draggable(s, {start: r, stop: a, drag: l}).resizable(s, {
                        start: r,
                        stop: a,
                        resize: l
                ...
                class r {
                    ...
                    _fixCollisions(t) {
                        this._sortNodes(-1);
                        let e = t, i = Boolean(this.nodes.find((t => t.locked)));
                        for (this.float || i || (e = {x: 0, y: t.y, w: this.column, h: t.h}); ;) {
                    ...
                    addNode(t, e = !1) {
                        if ((t = this.prepareNode(t)).autoPosition) {
                            this._sortNodes();
                            for (let e = 0; ; ++e) {
                                let i = e % this.column, r = Math.floor(e / this.column);
                                if (i + t.w > this.column) continue;
                                let o = {x: i, y: r, w: t.w, h: t.h};
                    ...
                    isOutside(t, e, i) {
                        ...
                        if (!i._temporaryRemoved) {
                            ...
                            }), o = Object.assign(Object.assign({}, i), {x: t, y: e});
                    ...
                    moveNode(t, e, i, s, r, o) {
                        ...
                        let n = t.w !== s || t.h !== r,
                            l = {x: e, y: i, w: s, h: r, maxW: t.maxW, maxH: t.maxH, minW: t.minW, minH: t.minH};
                    ...
                    updateNodeWidths(t, e, i, r = "moveScale") {
                        ...
                        let o = this._layouts[e] || [], n = this._layouts.length - 1;
                        ...
                        })), i.length) if ("function" == typeof r) r(e, t, l, i); else {
                            let s = e / t, o = "move" === r || "moveScale" === r,
                    ...
                    cacheLayout(t, e, i = !1) {
                        ...
                        return t.forEach(((t, e) => {
                            t._id = t._id || r._idSeq++, s[e] = {x: t.x, y: t.y, w: t.w, _id: t._id}
                ...
                const l = {
                    ...
                    draggable: {handle: ".grid-stack-item-content", scroll: !1, appendTo: "body"},
                    dragIn: void 0,
                    dragInOptions: {
                        revert: "invalid",
                        handle: ".grid-stack-item-content",
                ...
                class a {
                    constructor(t, e = {}) {
                        ...
                        let i = o.Utils.toNumber(t.getAttribute("gs-row")), s = Object.assign(Object.assign({}, l), {
                            ...
                            resizable: {autoHide: !e.alwaysShowResizeHandle, handles: "se"},
                            draggable: {
                                handle: (e.handleClass ? "." + e.handleClass : e.handle ? e.handle : "") || ".grid-stack-item-content",
                                scroll: !1,
                                appendTo: "body"
                            },
                            removableOptions: {accept: "." + (e.itemClass || "grid-stack-item")}
                        });
                        ...
                        if (n && n.gridstackNode && (this.opts._isNested = n.gridstackNode, this.opts._isNested.subGrid = this, this.el.classList.add("grid-stack-nested")), this._isAutoCellHeight = "auto" === this.opts.cellHeight, this._isAutoCellHeight || "initial" === this.opts.cellHeight ? this.cellHeight(void 0, !1) : this.cellHeight(this.opts.cellHeight, !1), this.el.classList.add(this.opts._styleSheetClass), this._setStaticClass(), this.engine = new r.GridStackEngine({
                            ...
                            this.getGridItems().forEach((e => {
                                let i = parseInt(e.getAttribute("gs-x")), s = parseInt(e.getAttribute("gs-y"));
                                t.push({
                                    el: e,
                    ...
                    getCellFromPixel(t, e = !1) {
                        ...
                        let r = t.left - i.left, o = t.top - i.top, n = s.width / this.opts.column,
                    ...
                    update(t, e) {
                        if (arguments.length > 2) {
                            ...
                            let i = arguments, s = 1;
                            return e = {x: i[s++], y: i[s++], w: i[s++], h: i[s++]}, this.update(t, e)
                        }
                        return a.getElements(t).forEach((t => {
                            if (!t || !t.gridstackNode) return;
                            let i = t.gridstackNode, s = Object.assign({}, e);
                    ...
                    willItFit(t) {
                        if (arguments.length > 1) {
                            ...
                            let t = arguments, e = 0,
                                i = {x: t[e++], y: t[e++], w: t[e++], h: t[e++], autoPosition: t[e++]};
                    ...
                    _triggerEvent(t, e) {
                        let i = e ? new CustomEvent(t, {bubbles: !1, detail: e}) : new Event(t);
                    ...
                    _updateStyles(t = !1, e) {
                        ...
                        let i = this.opts.cellHeight, s = this.opts.cellHeightUnit,
                        ...
                        if (!this._styles) {
                            ...
                            let n = this.opts.marginTop + this.opts.marginUnit,
                                ...
                                h = this.opts.marginLeft + this.opts.marginUnit, d = `${r} > .grid-stack-item-content`,
                    ...
                    _updateContainerHeight() {
                        ...
                        let t = this.getRow(), e = parseInt(getComputedStyle(this.el)["min-height"]);
                        if (e > 0) {
                    ...
                    onParentResize() {
                        ...
                        let t = !this.opts.disableOneColumnMode && this.el.clientWidth <= this.opts.minWidth, e = !1;
                    ...
                    locked(t, e) {
                        return this.update(t, {locked: e})
                    }

                    maxWidth(t, e) {
                        return this.update(t, {maxW: e})
                    }

                    minWidth(t, e) {
                        return this.update(t, {minW: e})
                    }

                    maxHeight(t, e) {
                        return this.update(t, {maxH: e})
                    }

                    minHeight(t, e) {
                        return this.update(t, {minH: e})
                    }

                    move(t, e, i) {
                        return this.update(t, {x: e, y: i})
                    }

                    resize(t, e, i) {
                        return this.update(t, {w: e, h: i})
                    }
                }

                e.GridStack = a, a.Utils = o.Utils, a.Engine = r.GridStackEngine
            }, 861: (t, e) => {
                Object.defineProperty(e, "__esModule", {value: !0}), e.DDBaseImplement = class {
                    constructor() {
                ...
                class n extends o.DDBaseImplement {
                    ...
                    _dragStart(t) {
                        ...
                        const e = r.DDUtils.initEvent(t, {target: this.el, type: "dragstart"});
                    ...
                    _drag(t) {
                        ...
                        const e = r.DDUtils.initEvent(t, {target: this.el, type: "drag"});
                    ...
                    _dragEnd(t) {
                        ...
                        const e = r.DDUtils.initEvent(t, {target: this.el, type: "dragstop"});
                ...
                class n extends r.DDBaseImplement {
                    ...
                    _dragEnter(t) {
                        ...
                        const e = o.DDUtils.initEvent(t, {target: this.el, type: "dropover"});
                    ...
                    _dragLeave(t) {
                        if (!this.el.contains(t.relatedTarget) && (this._removeLeaveCallbacks(), this.moving)) {
                            t.preventDefault();
                            const e = o.DDUtils.initEvent(t, {target: this.el, type: "dropout"});
                    ...
                    _drop(t) {
                        ...
                        t.preventDefault();
                        const e = o.DDUtils.initEvent(t, {target: this.el, type: "drop"});
                ...
                Object.defineProperty(e, "__esModule", {value: !0}), e.DDManager = class {
                }
            }, 680: (t, e) => {
                Object.defineProperty(e, "__esModule", {value: !0});
                ...
                Object.defineProperty(e, "__esModule", {value: !0});
                const s = i(680), r = i(861), o = i(943), n = i(593);
                ...
                class l extends r.DDBaseImplement {
                    constructor(t, e = {}) {
                        super(), this._showHandlers = () => {
                            ...
                            const t = this.el.parentElement.getBoundingClientRect(), e = {
                            ...
                            return {
                                position: {left: i.left - t.left, top: i.top - t.top},
                    ...
                    _resizeStart(t) {
                        ...
                        const e = o.DDUtils.initEvent(t, {type: "resizestart", target: this.el});
                    ...
                    _resizing(t, e) {
                        ...
                        const i = o.DDUtils.initEvent(t, {type: "resize", target: this.el});
                        return this.option.resize && this.option.resize(i, this._ui()), this.triggerEvent("resize", i), this
                    }

                    _resizeStop(t) {
                        const e = o.DDUtils.initEvent(t, {type: "resizestop", target: this.el});
                    ...
                    _getChange(t, e) {
                        const i = this.startEvent, s = {
                            ...
                            left: this.originalRect.left,
                            top: this.originalRect.top - this.scrolled
                        }, r = t.clientX - i.clientX, o = t.clientY - i.clientY;
                    ...
                    _getReShapeSize(t, e) {
                        const i = this.option.maxWidth || Number.MAX_SAFE_INTEGER, s = this.option.minWidth || t,
                            r = this.option.maxHeight || Number.MAX_SAFE_INTEGER, o = this.option.minHeight || e;
                        return {width: Math.min(i, Math.max(s, t)), height: Math.min(r, Math.max(o, e))}
                    }
                ...
                class i {
                    ...
                    static addElStyles(t, e) {
                        if (e instanceof Object) for (const i in e) e.hasOwnProperty(i) && (Array.isArray(e[i]) ? e[i].forEach((e => {
                            t.style[i] = e
                        })) : t.style[i] = e[i])
                    }
                ...
                Object.defineProperty(e, "__esModule", {value: !0});
                const s = i(849), r = i(485), o = i(21), n = i(593);
                !function (t) {
                    for (var i in t) e.hasOwnProperty(i) || (e[i] = t[i])
                }(i(21));
                ...
                class l extends o.GridStackDD {
                    resizable(t, e, i, s) {
                        return this._getDDElements(t).forEach((t => {
                            if ("disable" === e || "enable" === e) t.ddResizable && t.ddResizable[e](); else if ("destroy" === e) t.ddResizable && t.cleanResizable(); else if ("option" === e) t.setupResizable({[i]: s}); else {
                                ...
                                t.setupResizable(Object.assign(Object.assign(Object.assign({}, i.opts.resizable), {handles: s}), {
                                    start: e.start,
                                    stop: e.stop,
                                    resize: e.resize
                                }))
                    ...
                    draggable(t, e, i, s) {
                        return this._getDDElements(t).forEach((t => {
                            if ("disable" === e || "enable" === e) t.ddDraggable && t.ddDraggable[e](); else if ("destroy" === e) t.ddDraggable && t.cleanDraggable(); else if ("option" === e) t.setupDraggable({[i]: s}); else {
                                const i = t.el.gridstackNode.grid;
                    ...
                    droppable(t, e, i, s) {
                        return "function" != typeof e.accept || e._accept || (e._accept = e.accept, e.accept = t => e._accept(t)), this._getDDElements(t).forEach((t => {
                            "disable" === e || "enable" === e ? t.ddDroppable && t.ddDroppable[e]() : "destroy" === e ? t.ddDroppable && t.cleanDroppable() : "option" === e ? t.setupDroppable({[i]: s}) : t.setupDroppable(e)
                        })), this
                    }
                ...
                Object.defineProperty(e, "__esModule", {value: !0}), s(i(593)), s(i(62)), s(i(334)), s(i(270)), s(i(761))
            }, 593: (t, e) => {
                Object.defineProperty(e, "__esModule", {value: !0}), e.obsolete = function (t, e, i, s, r) {
                    ...
                    static removeInternalAndSame(t, e) {
                        if ("object" == typeof t && "object" == typeof e) for (let i in t) {
                            let s = t[i];
                    ...
                    static closestByClass(t, e) {
                        for (; t = t.parentElement;) if (t.classList.contains(e)) return t;
                        return null
                    }
                    ...
                    static updateScrollPosition(t, e, i) {
                        ...
                        if (s.top < 0 || s.bottom > r) {
                            let o = s.bottom - r, n = s.top, l = this.getScrollParent(t);
                            if (null !== l) {
                                let a = l.scrollTop;
                    ...
                    static updateScrollResize(t, e, i) {
                        const s = this.getScrollParent(e), r = s.clientHeight, o = t.clientY < i, n = t.clientY > r - i;
                        o ? s.scrollBy({behavior: "smooth", top: t.clientY - i}) : n && s.scrollBy({
                            behavior: "smooth",
                            top: i - (r - t.clientY)
                        })
                    }
